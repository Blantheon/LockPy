...
class TestDatabaseClass(unittest.TestCase):
    ...
    def tearDown(self):
        os.remove('/home/' + getuser() + '/Desktop/lockpy/sql/test.db')
    ...
    def test_create_table(self):
        ...
        self.assertTrue(os.path.isfile('/home/' + getuser() + '/Desktop/lockpy/sql/test.db'))
    

    def test_retrieve_in_db(self):
        with Database('test.db') as db, contextlib.redirect_stdout(self.f):
            db.select_in_db('all')
    ...
    def test_delete_in_db(self):
        ...
        self.assertEqual(cm.exception.args[0], 'The service entered doesn\'t exist or the table is empty')
